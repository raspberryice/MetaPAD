...
python metapad.py encrypt output/top-encrypted.txt output/top-label.txt output/top-positive.txt output/top-key.txt data/corpus_wildcard2.txt data/goodpattern_wildcard2.txt data/stopwords.txt TOP
python metapad.py encrypt output/bottom-encrypted.txt output/bottom-label.txt output/bottom-positive.txt output/bottom-key.txt data/corpus_wildcard2.txt data/goodpattern_wildcard2.txt data/stopwords.txt BOTTOM

python metapad.py encryptFast output/top-token-train.txt output/top-token-mapping.txt output/top-token-casesen.txt output/top-token-quality.txt data/corpus_wildcard2.txt data/goodpattern_wildcard2.txt TOP
python metapad.py encryptFast output/bottom-token-train.txt output/bottom-token-mapping.txt output/bottom-token-casesen.txt output/bottom-token-quality.txt data/corpus_wildcard2.txt data/goodpattern_wildcard2.txt BOTTOM
...
python metapad.py mptable output/top-table.txt output/top-metapattern.txt output/top-salient.csv output/top-key.txt data/corpus_wildcard2.txt data/goodclass.txt data/verbs.txt data/stopwords.txt TOP
python metapad.py mptable output/bottom-table.txt output/bottom-metapattern.txt output/bottom-salient.csv output/bottom-key.txt data/corpus_wildcard2.txt data/goodclass.txt data/verbs.txt data/stopwords.txt BOTTOM
